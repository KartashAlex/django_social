...
from django_tagging import settings
from django_tagging.utils import calculate_cloud, get_tag_list, get_queryset_and_model, parse_tag_input
from django_tagging.utils import LOGARITHMIC
from django_tagging.validators import isTag
...
class Tag(models.Model):
    ...
    A tag.
    """
    name = models.CharField(_('name'), maxlength=50, unique=True, db_index=True, validator_list=[isTag])
