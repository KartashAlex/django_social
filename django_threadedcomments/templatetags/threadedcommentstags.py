...
from django_threadedcomments.models import ThreadedComment, FreeThreadedComment
from django_threadedcomments.forms import ThreadedCommentForm, FreeThreadedCommentForm
...
def auto_transform_markup(comment):
    ...
    try:
        ...
        from django_threadedcomments.models import MARKDOWN, TEXTILE, REST, PLAINTEXT
